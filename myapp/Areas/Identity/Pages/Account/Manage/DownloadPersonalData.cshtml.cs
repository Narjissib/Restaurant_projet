...
namespace myapp.Areas.Identity.Pages.Account.Manage
{
    public class DownloadPersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                personalData.Add($"{l.LoginProvider} clé du fournisseur de connexion externe", l.ProviderKey);
            }

            personalData.Add($"Clé de l'authentificateur", await _userManager.GetAuthenticatorKeyAsync(user));
