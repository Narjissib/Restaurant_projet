...
{
    public class PlatSignatures1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public PlatSignatures1Controller(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: PlatSignatures1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PlatSignatures1/Create
